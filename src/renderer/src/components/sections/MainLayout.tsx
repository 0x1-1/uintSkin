  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-24 -top-32 w-[28rem] h-[28rem] rounded-full bg-primary-400/15 blur-3xl" />
        <div className="absolute right-[-18%] top-[-8%] w-[32rem] h-[32rem] rounded-full bg-secondary-400/10 blur-3xl" />
        <div className="absolute left-1/3 top-1/2 w-[36rem] h-[36rem] rounded-full bg-primary-700/10 blur-[120px]" />
        <div className="absolute inset-0 bg-[radial-gradient(1200px_at_40%_10%,rgba(255,255,255,0.04),transparent),linear-gradient(135deg,rgba(0,176,240,0.05),rgba(240,55,172,0.04),rgba(5,9,20,0.6))]" />
      </div>
