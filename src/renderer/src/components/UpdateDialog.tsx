      ...
      <DialogContent className="max-w-2xl">
          ...
          {isDownloading && (
            <div>
              <div className="flex items-center justify-between text-sm mb-1">
                <span className="text-text-muted">{t('update.downloading')}</span>
        ...
        <DialogFooter>
          <Button variant="secondary" onClick={handleCancel}>
            {isDownloading ? t('actions.cancel') : t('actions.later')}
          </Button>
          <Button
          ...
          >
            ...
            {isDownloading ? t('update.downloading') : t('actions.downloadAndInstall')}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
